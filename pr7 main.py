...
from pr7_pouch_l import pr7_when as tmod, pr7_calcbox as mmod, pr7_lucky as rmod, pr7_uider as uidmod, pr7_fileside as fmod, pr7_dirpeek as xmod
import math

def menu():
    print("\n========================")
    print("Welcome to Multi-Utility Toolkit (variant 12)")
    print("========================")
    ...
    while True:
        ...
        if c == "1":
            ...
            if ch == "1":
                ...
                import pr7_pouch_l as P; print([m for m in dir(P) if m.startswith("pr7_")])
        elif c == "7":
            print("Goodbye!"); break
        else:
            print("Invalid.")
